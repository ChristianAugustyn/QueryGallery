...
public class ImageListViewerActivity extends ListActivity
{
	...
	final static String IMAGE_INDEX_KEY = DemoCamera71179Activity.IMAGE_INDEX_KEY;
	final static String DIRECTORY_KEY = DemoCamera71179Activity.DIRECTORY_KEY;
	final static String IMAGE_FILENAMES_KEY = DemoCamera71179Activity.IMAGE_FILENAMES_KEY;
